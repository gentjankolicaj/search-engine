...
public class IndexBuilder implements Builder<Map<String, IndexSql>> {
    ...
    public Map<String, IndexSql> build() {
        ...
        IndexSql deleteDocToken = new IndexSql("delete from document_token where document_id=(?)", docId);
        ...
        IndexSql<List<String>> insertToken = new IndexSql<>(insertTokenQueries, insertTokenParams.toArray());
