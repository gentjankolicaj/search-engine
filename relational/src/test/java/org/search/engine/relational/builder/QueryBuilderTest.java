...
class QueryBuilderTest {
    ...
    void build() {
        ...
        List<String> input3 = Arrays.asList("query", "(", "butter", "|", "potato", ")", "&", "(", "salt", "|", "sugar", ")");
        ...
        assertEquals("select * from " + table + " where ( " + column + "=? or " + column + "=? ) ", query1);
        ...
        assertEquals("select * from " + table + " where ( " + column + "=? or " + column + "=? ) and " + column + "=? ", query2);
        ...
        assertEquals("select * from " + table + " where ( " + column + "=? or " + column + "=? ) and ( " + column + "=? or " + column + "=? ) ", query3);
    ...
    void buildSql() {
        ...
        String query1 = builder
                ...
                .setParams(input1)
                .buildSql();
        assertEquals("select * from " + table + " where ( " + column + "='butter' or " + column + "='milk' ) ", query1);
        ...
        String query2 = builder
                ...
                .setParams(input2)
                .buildSql();
        assertEquals("select * from " + table + " where ( " + column + "='butter' or " + column + "='potato' ) and " + column + "='salt' ", query2);
        ...
        String query3 = builder
                ...
                .setParams(input3)
                .buildSql();
        assertEquals("select * from " + table + " where ( " + column + "='butter' or " + column + "='potato' ) and ( " + column + "='salt' or " + column + "='sugar' ) ", query3);
