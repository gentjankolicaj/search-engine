...
class CommandParserImplTest {
    ...
    void testParseIndex() {
        ...
        CommandParseException cpe0 = assertThrows(CommandParseException.class, () -> commandParser.parse(input2));
        assertTrue(cpe0.getMessage().contains("Can't parse input"));

        CommandParseException cpe1 = assertThrows(CommandParseException.class, () -> commandParser.parse(input3));
    ...
    void testParseQuery() {
        ...
        CommandParseException cpe1 = assertThrows(CommandParseException.class, () -> commandParser.parse(input4));
        assertTrue(cpe1.getMessage().contains("Can't parse unknown input"));

        CommandParseException cpe2 = assertThrows(CommandParseException.class, () -> commandParser.parse(input5));
        assertTrue(cpe2.getMessage().contains("Can't parse input"));

        CommandParseException cpe3 = assertThrows(CommandParseException.class, () -> commandParser.parse(input6));
        assertTrue(cpe3.getMessage().contains("Can't parse input"));

        CommandParseException cpe4 = assertThrows(CommandParseException.class, () -> commandParser.parse(input7));
