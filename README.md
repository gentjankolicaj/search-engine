...
<br>Run relational or elastic app.If both relational & elastic are running they compete for the message on queue 'command' and only one receives the message.
